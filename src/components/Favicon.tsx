...
const Favicon = ({
  ...
  const faviconHost = url.replace(/^https?:\/\//, '').split('/')[0]

  const faviconUrl = `https://www.google.com/s2/favicons?domain=${faviconHost}&sz=64`
  const fallbackUrl = `https://${faviconHost}/favicon.ico` // Local asset or remote placeholder
